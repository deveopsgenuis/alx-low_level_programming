...
This project was created by [deveopsgenuis](https://github.com/deveopsgenuis) to practice building and using singly linked lists in C while learning when and why to use linked lists versus arrays.
